...
func TestNonCentralTProbability(t *testing.T) {
	...
	for i, c := range cases {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			e := NonCentralT{c.ν, c.μ}

			res := e.Probability(c.t)
...
func TestNonCentralTDistribution(t *testing.T) {
...
func TestNonCentralTCDMean(t *testing.T) {
...
func TestNonCentralTCDMeanNaN(t *testing.T) {
