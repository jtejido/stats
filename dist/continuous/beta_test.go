...
func TestBetaProbability(t *testing.T) {
	tol := 0.0000001
	cases := []struct {
		x, a, b  float64
		expected float64
...
func TestBetaMedian(t *testing.T) {
	tol := 0.00001
	cases := []struct {
		a, b     float64
		expected float64
...
func TestBetaMedianApproximation(t *testing.T) {

	cases := []struct {
		a, b                    float64
		expected, expectedError float64
	}{
	...
	for i, c := range cases {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			res := b.Median()
			ε := math.Abs(c.expected - res)
			η := ε / c.expected
			if η >= c.expectedError {
				t.Errorf("Mismatch. Case %d, want: %v, got: %v", i, true, η < c.expectedError)
			}
...
// Generated with Mathematica Skewness[BetaDistribution[a, b]]
func TestBetaSkewness(t *testing.T) {
	tol := 0.00001
	cases := []struct {
		a, b     float64
		expected float64
...
// Generated with Mathematica kurtosisexcess[BetaDistribution[a, b]]
func TestBetaExKurtosis(t *testing.T) {
	tol := 0.00001
	cases := []struct {
		a, b     float64
		expected float64
